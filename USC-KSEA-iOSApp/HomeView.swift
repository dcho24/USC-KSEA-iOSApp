...
struct HomeView: View {
    ...
    @State private var selectedTab = 0  // initiate selected tab
...
//                        Footer(selectedTab)
            ...
            // Set tag that corresponds to each tab view
                        .tag(0)
                        .tabItem {
            ...
            //                .background(.white)
                    ...
                    .onAppear() {
                        UITabBar.appearance().backgroundColor = UIColor(red: 0.62, green: 0.13, blue: 0.21, alpha: 1.0)
                    }
//
    }
}
